...
dike_2050_failure = lambda average_water_level, surge_frequency:  frequency_failure( surge_frequency, dike_par , average_water_level, base_year=1000,N=1000)
...
for i in range(5):
    F_standard=dike_2050_failure(ijssel_lev,frozen_surge_model)
    print('issel')
    print(F_standard)